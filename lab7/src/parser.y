...
%token <ftype> FNUM
%token IF ELSE DO WHILE FOR CONST 
...
%type <stmttype> Stmts Stmt ExprStmt AssignStmt BlockStmt IfStmt WhileStmt ReturnStmt DeclStmt FuncDef VarDecl ConstDecl VarDef VarList ConstDef ConstList BreakStmt ContinueStmt BlankStmt FuncFParam FuncFParams MFuncFParams
%type <exprtype> Exp AddExp Cond LOrExp PrimaryExp LVal RelExp LAndExp EqExp UnaryExp MulExp ConstExp ConstInitVal FuncRParams ArrayIndices FuncArrayIndices InitVal InitValList ConstInitValList
%type <type> Type
...
FuncArrayIndices 
    ...
    | FuncArrayIndices LBRACK Exp RBRACK {
        $$ = $1;
        $$->setNext($3);
    }
DeclStmt
...
ArrayIndices
    ...
    | ArrayIndices LBRACK ConstExp RBRACK {
        $$ = $1;
        $1->setNext($3);
    }
    ;
